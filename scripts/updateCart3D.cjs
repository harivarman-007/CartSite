...
const content = `import React, { useRef, useMemo, useState, useEffect } from "react";
...
fs.writeFileSync("src/components/Cart3D.jsx", content, "utf8");
console.log("Cart3D.jsx successfully updated with hero interactivity, clean keyframes, and ocean breeze materials.");
